...
function rollDice() {
    ...
    $('.dice.hold').removeClass('selectable'); // TODO: remove the 'selectable' class from all elements that have both
    //       the 'die' and 'hold' class
$('.die.selectable').attr('data-roll', randomRoll);//mine
...
function restartGame() {
    // EXAMPLE:
    $('.die').addClass('selectable');// TODO: add the class 'selectable' to every element
    //       with the 'die' class
